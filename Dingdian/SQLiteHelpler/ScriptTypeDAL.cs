...
//        {
//            SQLiteHelpler.SQLiteUtils.ExecuteNonQuery(@"insert into TB_ScriptType(ScriptTypeId,ScriptType,IsUsing)
...
//        {
//            SQLiteHelpler.SQLiteUtils.ExecuteNonQuery(@"update TB_ScriptType set ScriptType=@ScriptType,
...
//        {
//            DataTable table = SQLiteHelpler.SQLiteUtils.GetDataTable("select * from TB_ScriptType where ScriptTypeId=@id",
...
//        {
//            DataTable table = SQLiteHelpler.SQLiteUtils.GetDataTable("select * from TB_ScriptType where ScriptType=@name",
...
//        {
//            DataTable table = SQLiteHelpler.SQLiteUtils.GetDataTable("select * from TB_ScriptType where IsUsing=1");
...
//        {
//            DataTable table = SQLiteHelpler.SQLiteUtils.GetDataTable(sql, parameterList.ToArray());
//            ScriptTypeM[] type = new ScriptTypeM[table.Rows.Count];
//            for (int i = 0; i < table.Rows.Count; i++)
//            {
//                type[i] = ToScriptType(table.Rows[i]);
